...
try {
    ...
    $ig->direct->sendStory($recipients, $storyItems[0]->getId(), null, ['client_context' => $clientContext]);

    $ig->event->sendDirectMessageIntentOrAttempt('send_intent', $clientContext, 'reel_share', [$recipientUserId]);
    $ig->event->sendDirectMessageIntentOrAttempt('send_attempt', $clientContext, 'reel_share', [$recipientUserId]);
    $ig->event->sendDirectMessageIntentOrAttempt('sent', $clientContext, 'reel_share', [$recipientUserId]);
