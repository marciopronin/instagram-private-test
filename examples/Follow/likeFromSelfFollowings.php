...
try {
    ...
    foreach ($followingList as $following) {
        ...
        $ig->event->sendProfileView($following);

        $ig->people->getFriendship($following);
        $ig->highlight->getUserFeed($following);
        $ig->people->getInfoById($following);
        $ig->story->getUserStoryFeed($following);
