...
try {
    ...
    $ig->event->sendOrganicNumberOfLikes($items[0], 'feed_contextual_self_profile');
    ...
    $ig->event->sendNavigation('media_likes', 'feed_contextual_self_profile', 'likers');
    ...
    foreach ($randomFollowers as $follower) {
        ...
        $ig->event->sendNavigation('back', 'profile', 'likers');
