    ...
    public function updateSettingsState()
    {
        ...
        if ($handle) {
            while (($line = fgets($handle)) !== false) {
                ...
                $line = $this->_searchAndReplaceSetting($line, 'BaseCX', OBS_X);
                $line = $this->_searchAndReplaceSetting($line, 'BaseCY', OBS_Y);
                $line = $this->_searchAndReplaceSetting($line, 'OutputCX', OBS_X);
                $line = $this->_searchAndReplaceSetting($line, 'OutputCY', OBS_Y);
                if ($currentSection = 'SimpleOutput') {
                    $line = $this->_searchAndReplaceSetting($line, 'VBitrate', OBS_BITRATE);
