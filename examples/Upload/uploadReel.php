...
try {
    ...
    $video = new \InstagramAPI\Media\Video\InstagramVideo($videoFilename, ['targetFeed' => \InstagramAPI\Constants::FEED_REELS]);
    $ig->reel->uploadVideo($video->getFile(), ['caption' => $captionText]);
} catch (\Exception $e) {
