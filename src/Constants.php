...
class Constants
{
    ...
    const IG_VERSION = '296.0.0.35.109';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '505599021', // arm64 - Android 9+ - 640,560dpi (default)
        '505599021', // arm64 - Android 9+ - nodpi
        '505599021', // armv7 - Android 5+ - nodpi
        '505599021', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '6c430a3ed39744544edbb8460326bdb3adc57c3fdf63df43ab94b3cdb76230b6';
