...
class Constants
{
    ...
    const IG_VERSION = '347.0.0.40.103';
    ...
    const IG_PASSWORD_ENCRYPTION_VERSION = 1;
    const IG_PASSWORD_ENCRYPTION_TAG = '#PWD_INSTAGRAM';
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '1abb37368628c875d2c61e4c3e261f689e01a0620b67dc240155567095ebb814';
    ...
    const X_FB_HTTP_Combined_Engine = 'Tigon/Liger';
    ...
    // Web.
    const WEB_USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.5938.63 Safari/537.36';
