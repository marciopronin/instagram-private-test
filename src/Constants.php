...
class Constants
{
    ...
    const IG_VERSION = '228.0.0.15.111';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = '362801245';
    ...
    const MOBILE_CONFIG_EXPERIMTENTS = ['ig_android_dark_mode_user_override', 'ig_ios_dark_mode_toggle_dummy', 'ig_android_memory_instance_event', 'ig_session_chain_configs', 'igd_large_account_error_status_config', 'igd_professional_inbox_message_requests_upranking_v2', 'ig_android_smb_professional_account_signup_for_fb_ci_device_id_launcher', 'ig_smb_android_create_pro_device_level_backtest_launcher', 'ig_android_camera_network_activity_logger', 'ig_android_reels_cross_posting_deviceid_launcher', 'ig_android_crosspost_to_fb_attribution_clickable_overwrite', 'ig_android_direct_messaging_tab_device', 'ig_android_keyboard_detector_device', 'always_use_server_recents', 'fbns', 'ig_android_oppo_badging_fix_android_11', 'android_fx_access_device_library_ig4a', 'caa_ar_native_integration_point_ig_logged_out', 'caa_ig4a_smartlock_delete_killswitch', 'caa_ig4a_smartlock_fetch_killswitch', 'caa_ig4a_smartlock_handle_incorrect_pwd_killswitch', 'caa_ig4a_smartlock_save_killswitch', 'caa_login_native_integration', 'caa_password_flow_bloks_login_api', 'fx_android_replicated_storage_ig', 'fx_ig4a_cal_reg_account_recovery', 'fx_ig4a_nux_import_profile_pic_launcher', 'fx_ig4a_sac_linking_device_id_client_launcher', 'fx_ig_android_profile_badge_clear_on_tap', 'fx_ig_show_is_after_nux_linking_android', 'fx_ig_show_nux_is_android_upsell', 'ig4a_fdid_aa_test', 'ig4a_fdid_asdid_sync_killswitch', 'ig4a_fdid_oe_validation_launcher', 'ig4a_multiple_ar_fdid_backtest_launcher', 'ig4a_multiple_ar_lid_backtest_launcher', 'ig4a_reg_cal_contact_point_claiming_killswitch', 'ig_account_recovery_prefill', 'ig_android_access_control', 'ig_android_account_switch_black_banner_go_back_cta', 'ig_android_always_show_password_reg', 'ig_android_autobackup_killswitch', 'ig_android_caa_bloks_testing_contact_point_screen', 'ig_android_cal_nux', 'ig_android_cal_reg_fix_kill_switch', 'ig_android_device_quick_promotion', 'ig_android_double_tap_additional_entry_points_config', 'ig_android_double_tap_to_switch_timeout_config', 'ig_android_entry_point_to_cis_surface', 'ig_android_eu_data_transfer_consent', 'ig_android_explicit_tos_screen', 'ig_android_fix_username_invalid_character_error_message', 'ig_android_follow_from_other_accounts', 'ig_android_fx_linking_survey_with_callback', 'ig_android_import_content_to_new_account_launcher', 'ig_android_launcher_shortcut_for_account_switch_config', 'ig_android_legacy_consent_platform_device_based_v1', 'ig_android_long_press_education_tooltip_profile_entrypoint_launcher', 'ig_android_loose_the_limit_to_add_account_in_account_switcher_launcher', 'ig_android_mac_mimicry_owner', 'ig_android_mimicry_on_profile_owner', 'ig_android_mimicry_on_profile_visitor', 'ig_android_mutiple_account_launcher_badge_config_v2', 'ig_android_never_show_add_age_link', 'ig_android_one_tap_upsell_dialog_migration', 'ig_android_password_creation_for_passwordless_user_config', 'ig_android_phone_confirmation_screen_experiment_v1', 'ig_android_prototype_recovery_screen_using_bloks_launcher', 'ig_android_recovery_password_reset_password_visibility', 'ig_android_registration_phone_field_direction_experiment', 'ig_android_remove_invalid_nonce', 'ig_android_share_post_to_other_account_launcher', 'ig_android_show_no_multi_mainaccount_when_linked_in_cal_error_dialog_launcher', 'ig_android_smart_prefill_killswitch', 'ig_android_sony_badging', 'ig_android_stop_using_server_corrected_email', 'ig_ci_ndx_upsell_learn_more', 'ig_save_ccu_state_after_account_creation_v2', 'ndx_ig4a_ma_as_experiment', 'ndx_ig4a_ma_as_killswitch', 'paid_ads_ig4a_attribution_sessionless', 'paid_ads_ig4a_privacy_compliance', 'fizz_ig_android', 'ig_android_app_release_channel', 'ig_android_app_startup_sticky_country', 'ig_android_bitmap_cache_weak_ref_cleaner', 'ig_android_drawable_usage_logging', 'ig_android_flytrap_screenshot', 'ig_android_force_switch_dialog_device', 'ig_android_image_clear_disk_cache', 'ig_android_layout_oom', 'ig_android_leak_bitmap', 'ig_android_memory_leak_reporting', 'ig_android_memory_manager_lib', 'ig_android_os_version_blocking_config', 'ig_android_qpl_server_push_phase_metadata', 'ig_android_qpl_use_runtime_stats', 'ig_android_release_velocity_dod', 'ig_android_roomdb_session_end_close', 'ig_android_saf_deeplink', 'ig_session_change_fix', 'ig_user_mismatch_soft_error', 'sonar_prober_launcher', 'user_model_configuration', 'live_special_codec_size_list', 'qe_ig_android_device_detection_info_upload', 'qe_ig_android_device_info_foreground_reporting', 'qe_ig_android_device_verification_fb_signup', 'qe_ig_android_device_verification_separate_endpoint', 'qe_ig_android_fb_account_linking_sampling_freq_universe', 'qe_ig_android_gmail_oauth_in_reg', 'qe_ig_android_login_identifier_fuzzy_match', 'qe_ig_android_passwordless_account_password_creation_universe', 'qe_ig_android_quickcapture_keep_screen_on', 'qe_ig_android_security_intent_switchoff', 'qe_ig_android_sim_info_upload', 'qe_ig_android_suma_landing_page', 'qe_ig_growth_android_profile_pic_prefill_with_fb_pic_2', 'ig4a_bug_report_endpoint_with_module_class', 'ig4a_mobileconfig_device', 'ig_android_aed', 'ig_android_badging_on_transsion', 'ig_android_push_token_security_change', 'ig_device_session_canary_test', 'igns_af_dot_badging', 'read_cached_login_users_anr_device', 'ig_privacy_core_policy_zones_android', 'multiple_account_badging_platform_migration_new', 'ig_android_seller_actions_deeplink_config', 'ig_android_creation_external_storage_permission', 'ig_android_recycleravatar', 'ig_threads_android_cf_plus_notif_killswitch', 'ig_threads_android_post_sunset', 'ig_android_bottom_sheet_lifecycle_fix', 'ig_android_component_ax_device_id', 'ig_android_component_ax_device_id_v2', 'ig_android_fragmen_navigation_concurrency_fix', 'ig_android_igds_illustration_override_enabled_killswitch', 'ig_android_igds_snackbar_refresh_launcher', 'ig_android_increase_action_bar_tap_area_config', 'ig_android_per_activity_resources', 'ig_ax_action_bar_focus', 'ig_branding_2021_launcher', 'ig_downloadable_images', 'ig_igds_android_panavision_buttons', 'ig_ikons_sl', 'ig_android_codec_high_profile', 'ig_android_media_codec_info_collection', 'ig_android_pendingmedia_gc_ttl', 'ig_android_video_width_policy_deviceid'];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '1316f19edb7b9651d41fa437317677072b955fa30fea1d690a5b1ed52196ff56';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '114.0,115.0,116.0,117.0,118.0,119.0,120.0,121.0,122.0,123.0,124.0,125.0,126.0,127.0,128.0,129.0,130.0,131.0,132.0,133.0,134.0,135.0',
        ],
        [
