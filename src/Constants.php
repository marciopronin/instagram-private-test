...
class Constants
{
    ...
    // Facebook Constants.
    public const FACEBOOK_OTA_FIELDS = 'update%7Bdownload_uri%2Cdownload_uri_delta_base%2Cversion_code_delta_base%2Cdownload_uri_delta%2Cfallback_to_full_update%2Cfile_size_delta%2Cversion_code%2Cpublished_date%2Cfile_size%2Cota_bundle_type%2Cresources_checksum%2Cresources_sha256_checksum%2Callowed_networks%2Crelease_id%7D';
    public const FACEBOOK_ORCA_PROTOCOL_VERSION = 20150314;
    public const FACEBOOK_ORCA_APPLICATION_ID = '124024574287414';
    public const FACEBOOK_ANALYTICS_APPLICATION_ID = '567067343352427';
    public const GRAPH_API_ACCESS_TOKEN = 'f249176f09e26ce54212b472dbab8fa8';

    // MQTT Constants.
    public const PLATFORM = 'android';
    public const FBNS_APPLICATION_NAME = 'MQTT';
    public const INSTAGRAM_APPLICATION_NAME = 'Instagram';
    public const PACKAGE_NAME = 'com.instagram.android';

    // Internal Feedtype Constants. CRITICAL: EVERY value here MUST be unique!
    public const PROFILE_PIC = -1;
    public const FEED_TIMELINE = 1;
    public const FEED_TIMELINE_ALBUM = 2;
    public const FEED_STORY = 3;
    public const FEED_DIRECT = 4;
    public const FEED_DIRECT_STORY = 5;
    public const FEED_TV = 6;
    public const FEED_REELS = 9; // Clips
    public const FEED_DIRECT_AUDIO = 11;
    public const FEED_LIVE = 12;

    // Story view modes.
    public const STORY_VIEW_MODE_ONCE = 'once';
    public const STORY_VIEW_MODE_REPLAYABLE = 'replayable';
    public const STORY_VIEW_MODE_PERMANENT = 'permanent';

    // Web.
    public const WEB_USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.5938.63 Safari/537.36';
    public const WEB_CHALLENGE_USER_AGENT = 'Mozilla/5.0 (Linux; Android 10; MI 8 Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.91 Mobile Safari/537.36';
    ...
    public const PDQ_VIDEO_TIME_FRAMES = [
        0,
        1.0,
        2.0,
        3.0,
