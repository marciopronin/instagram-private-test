...
class Constants
{
    ...
    const IG_VERSION = '303.0.0.40.109';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '522819575', // arm64 - Android 9+ - 640,560dpi (default)
        '522819575', // arm64 - Android 9+ - nodpi
        '522819575', // armv7 - Android 5+ - nodpi
        '522819575', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '3f4240262afea821ce4356120b8a34056b6618b08090f4d51a285cc3fac8d6c7';
