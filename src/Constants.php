...
class Constants
{
    ...
    const IG_VERSION = '269.0.0.18.75';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '444561848', // arm64 - Android 9+ - 640,560dpi (default)
        '444561840', // arm64 - Android 9+ - nodpi
        '444561817', // armv7 - Android 5+ - nodpi
        '444561836', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '271d5c6ca292d9abdab08a3a3776b8ec1c903d8c1b3eeeab0bcbb98519e598f0';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0,143.0,144.0,145.0,146.0,147.0,148.0,149.0,150.0,151.0,152.0,153.0,154.0,155.0,156.0',
        ],
        [
