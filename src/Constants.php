...
class Constants
{
    ...
    const IG_VERSION = '293.0.2.28.93';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '497870495', // arm64 - Android 9+ - 640,560dpi (default)
        '497870495', // arm64 - Android 9+ - nodpi
        '497870462', // armv7 - Android 5+ - nodpi
        '497870462', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '14e68383f72df1ac7e68fcb057b6741807acf23e80d74305804f2544f1269080';
