...
class Constants
{
    ...
    const IG_VERSION = '302.1.0.36.111';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '520702296', // arm64 - Android 9+ - 640,560dpi (default)
        '520702296', // arm64 - Android 9+ - nodpi
        '520702296', // armv7 - Android 5+ - nodpi
        '520702296', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '30b40ac73281a666fbb612e6aab43709170f95c864bf4bcb67b10f4300fe8a1a';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0,143.0,144.0,145.0,146.0,147.0,148.0,149.0,150.0,151.0,152.0,153.0,154.0,155.0,156.0,157.0,158.0,159.0,160.0,161.0,162.0,163.0,164.0,165.0,166.0,167.0,168.0,169.0,170.0,171.0',
        ],
        [
