...
class Constants
{
    ...
    const IG_VERSION = '280.0.0.18.114';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '468688354', // arm64 - Android 9+ - 640,560dpi (default)
        '468688348', // arm64 - Android 9+ - nodpi
        '468688337', // armv7 - Android 5+ - nodpi
        '468688346', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '2d1b867e83739670862ed111d4a64b1af368e50a33ca510e1e3118571b0646fb';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0,143.0,144.0,145.0,146.0,147.0,148.0,149.0,150.0,151.0,152.0,153.0,154.0,155.0,156.0,157.0,158.0,159.0,160.0,161.0,162.0',
        ],
        [
