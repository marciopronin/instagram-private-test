...
class Constants
{
    ...
    const IG_VERSION = '266.0.0.19.106';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '438795761', // arm64 - Android 9+ - 640,560dpi (default)
        '438795744', // arm64 - Android 9+ - nodpi
        '438795699', // armv7 - Android 5+ - nodpi
        '438795699', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = 'a7230560b5078ccef167a197a18954fa265dacb75c224b0de7922d1086c43cfb';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0,143.0,144.0,145.0,146.0,147.0,148.0,149.0,150.0,151.0,152.0,153.0,154.0,155.0',
        ],
        [
