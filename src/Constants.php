...
class Constants
{
    ...
    const IG_VERSION = '285.0.0.25.62';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '479968476', // arm64 - Android 9+ - 640,560dpi (default)
        '479968476', // arm64 - Android 9+ - nodpi
        '479968445', // armv7 - Android 5+ - nodpi
        '479968445', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = 'a972d28f4dce85acc2d13c958e43cb12e5c549cbefdc3e89bc8863afcd3d98db';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0,142.0,143.0,144.0,145.0,146.0,147.0,148.0,149.0,150.0,151.0,152.0,153.0,154.0,155.0,156.0,157.0,158.0,159.0,160.0,161.0,162.0,163.0,164.0',
        ],
        [
