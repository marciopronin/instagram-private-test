...
class Constants
{
    ...
    const IG_VERSION = '300.0.0.29.110';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '515103474', // arm64 - Android 9+ - 640,560dpi (default)
        '515103474', // arm64 - Android 9+ - nodpi
        '515103474', // armv7 - Android 5+ - nodpi
        '515103474', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '521ea70a72c103e016c2ffa10d09834a109b7f5af5ec7a7c9a0e20e3b5bc71d9';
