...
class Constants
{
    ...
    const IG_VERSION = '287.0.0.25.77';
    const IG_IOS_VERSION = '212.1.0.25.118';
    const VERSION_CODE = [
        '483850202', // arm64 - Android 9+ - 640,560dpi (default)
        '483850202', // arm64 - Android 9+ - nodpi
        '483850202', // armv7 - Android 5+ - nodpi
        '483850202', // armv7 - Android 5+ - 560,640dpi
    ];
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '2ea4bf9bc876166cf5827959414cb0ac923a49e48c8b91e3e4ad3f92efd4fa4c';
