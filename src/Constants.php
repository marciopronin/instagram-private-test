...
class Constants
{
    ...
    const IG_VERSION = '345.0.0.48.95';
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '5db86e281699ffa82bb79e45e1f7354cae64faae523ea6754e668a67870b7ab1';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value' => '149.0,150.0,151.0,152.0,153.0,154.0,155.0,156.0,157.0,158.0,159.0,160.0,161.0,162.0,163.0,164.0,165.0,166.0,167.0,168.0,169.0,170.0,171.0,172.0,173.0,174.0,175.0,176.0,177.0,178.0,179.0,180.0,181.0,182.0,183.0,184.0,185.0,186.0,187.0',
        ],
        [
            'name'  => 'SUPPORTED_BETA_SDK_VERSIONS',
            'value' => '187.0-beta,188.0-beta,189.0-beta',
        ],
        [
