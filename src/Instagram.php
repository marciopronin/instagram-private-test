                ...
                $response = $this->request('bloks/apps/com.bloks.www.bloks.caa.login.async.send_login_request/')
                    ...
                    ->addPost('params', json_encode([
                        ...
                        'server_params'         => [
                            ...
                            'INTERNAL__latency_qpl_marker_id'               => isset($this->bloksInfo['INTERNAL__latency_qpl_marker_id']) && count($this->bloksInfo['INTERNAL__latency_qpl_marker_id']) > 1 ? intval($this->bloksInfo['INTERNAL__latency_qpl_marker_id'][1]) : 0,
