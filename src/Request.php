...
class Request
{
    ...
    public function getRawResponse()
    {
        ...
        if ($body === '<meta http-equiv="refresh" content="0; url=instagram://checkpoint/dismiss" />') {
            $body = json_encode(['message' => 'challenge_finished']);
        }
        if (strpos($body, 'i.instagram.com/terms/accept/') !== false) {
            $body = json_decode($body, true);
            $body['message'] = 'consent_required';
