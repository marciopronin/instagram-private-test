...
class Hashtag extends RequestCollection
{
    ...
    public function getFollowChainingRecs(
        ...
        return $this->ig->request("tags/{$urlHashtag}/follow_chaining_recs/")
            ->getResponse(new Response\FollowChainingRecsResponse());
    }
    ...
    public function getAllFollowChainingRecs(
        ...
        return $this->ig->request("tags/{$urlHashtag}/see_all_follow_chaining_recs/")
            ->getResponse(new Response\FollowChainingRecsResponse());
    }
    ...
    public function markStoryMediaSeen(
        ...
        return $this->ig->internal->markStoryMediaSeen($items, $sourceId, 'hashtag_feed', $skippedItems);
    }
}
