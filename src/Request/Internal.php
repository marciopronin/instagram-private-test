        ...
        $prelogin)
    {
        ...
        if ($prelogin) {
            $request
                ...
                ->addPost('unit_type', 1)
                ->addPost('query_hash', '0b8932af85bea0d9f840af7c50f88bf8abbc69734962aec7a2d414d0d3f11519')
                ->addPost('ts', time())
            ...
            $request
                ...
                ->addPost('unit_type', 2)
                ->addPost('query_hash', 'a4ff112a6bfcffca7d31333f7829cc2235f490ba8a2619edfc20f7a538fb6147');
        }
