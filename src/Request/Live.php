...
//            ->addParam('num_comments_requested', $commentsRequested)
     ...
     * @param string|null $charityId   (optional) Charity ID. Numerical UserPK ID.
     *
     * @throws \InstagramAPI\Exception\InstagramException
     *
        ...
        $charityId = null)
    {
        ...
        if ($charityId !== null) {
            $request->addPost('charity_id', $charityId);
        }

        $response = $request->getResponse(new Response\StartLiveResponse());
     ...
     *
     * @param string $userId     Numerical UserPK ID.
     * @param string $preference The subscription preference:
     *                           - default: Get some notifications.
     *                           - all:     Get all notifications.
     *                           - none:    Don't get any notification.
     *
     * @throws \InstagramAPI\Exception\InstagramException
     *
     * @return \InstagramAPI\Response\GenericResponse
        ...
        $maxId = null)
    {
        ...
        return $request->getResponse(new Response\StoryCharitiesResponse());
    }

    /**
     * Get default charities.
     *
     * @param string $query Query for searching charities.
     *
     * @throws \InstagramAPI\Exception\InstagramException
     *
     * @return \InstagramAPI\Response\StoryCharitiesResponse
