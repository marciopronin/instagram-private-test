 ...
 * @method Model\StoryMentions getStoryMentions()
 ...
 * @method $this setStoryMentions(Model\StoryMentions $value)
 ...
 * @method $this unsetStoryMentions()
...
class ActivityNewsResponse extends Response
{
    const JSON_PROPERTY_MAP = [
        ...
        'story_mentions'         => 'Model\StoryMentions',
    ];
}
